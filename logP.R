...
logp.x.train<-logp.train%>%select( psa,acd_most_apka, acd_most_bpka, hba,hbd,rtb, aromatic_rings) # 76%
logp.y.train<-logp.train$standard_value


logp.rf.mdl <-randomForest(logp.y.train,x=logp.x.train,mtry=7,ntree=1500)
print(logp.rf.mdl)
